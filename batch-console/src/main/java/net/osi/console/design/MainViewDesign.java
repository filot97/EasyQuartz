package net.osi.console.design;
...
public class MainViewDesign extends HorizontalLayout {
	...
	protected Button schedulerState;
	protected Button cronTriggers;
	protected Button firedTriggers;
	protected Button jobDetails;
	protected Button triggers;
